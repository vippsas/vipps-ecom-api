...
| Initiate, reservation of maximum amount (for EV charging, parking, etc) | `Midlertidig reservasjon. Du bli kun belastet for faktisk bruk.` English: `Temporary reservation. You will only be charge for the actual use.` |
