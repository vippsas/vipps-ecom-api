...
- [Callbacks](#callbacks)   
  - [Callback endpoints](#callback-endpoints)   
     ...
     - [Consent removal](#consent-removal)   
...
The callback request body contains different information depending on the payment type:
...
There three types of callbacks, each specified when initiating the payment with
...
|:----------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|:-|
| callbackPrefix        | Payment update sent from Vipps                                                                                                                  | [`POST:[callbackPrefix]/v2/payments/{orderId}`](https://vippsas.github.io/vipps-developer-docs/api/ecom#tag/Merchant-Endpoints/operation/transactionUpdateCallbackForRegularPaymentUsingPOST) |
...
This callback is used by Vipps to send payment updates to the merchant.
...
This callback is used by Vipps for Vipps Hurtigkasse (express checkout) to
retrieve shipping details: Vipps sends the user's address information and the
merchant responds with the shipping details for that address.

#### Consent removal

This callback is used by Vipps when a user withdraws his/her consent to share
data with the merchant. The user does this in the Vipps app.
