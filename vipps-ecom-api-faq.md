...
- [Problems for end users](#problems-for-end-users)
  - [Why don't I receive the payment notification?](#why-dont-i-receive-ther-payment-notification)
  - [Why am I not sent back to where I came from when I have paid?](#why-am-i-not-sent-back-wo-where-i-came-from-when-i-have-paid)
  - [Why can't I scan the Vipps QR on the terminal with the camera app?](#why-cant-i-scan-the-qr-on-the-terminal-with-the-camera-app)
